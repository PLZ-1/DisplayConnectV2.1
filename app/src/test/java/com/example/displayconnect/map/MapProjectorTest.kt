...
class MapProjectorTest {
    @Test fun centerIsCenteredOnLandscapeMap() {
        assertEquals(240 to 116, MapProjector.projectPoint(0.0, 0.0, 0.0, 0.0, 200.0))
    }
    ...
    @Test fun equalDistancesHaveEqualScaleOnBothAxes() {
        ...
        assertEquals(58, east.first - 240)
        assertEquals(east.first - 240, 116 - north.second)
    }

    @Test fun farCoordinatesStayWithinMap() {
        assertEquals(479 to 0, MapProjector.projectPoint(0.0, 0.0, 1.0, 1.0, 200.0))
