...
static MapsTheme s_theme = MAPS_THEME_DARK;
...
void mapsThemeInit() {
  // This hardware profile uses dark mode, including boards that saved light mode.
  s_theme = MAPS_THEME_DARK;
}
...
uint16_t mapsColLand() {
  return mapsThemeIsDark() ? rgb565(16, 20, 26) : rgb565(248, 249, 251);
}
...
uint16_t mapsColCard() {
  return mapsThemeIsDark() ? rgb565(24, 28, 36) : rgb565(255, 255, 255);
}
